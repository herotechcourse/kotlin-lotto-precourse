...
class Lotto(private val numbers: List<Int>) {
    ...
    private fun countMatchingNumbers(ticket: Ticket): Int {
    ...
    fun compareTicketsAndLottoNumbers(tickets: List<Ticket>): Map<Prize, Int> {
        val prizeCount = mutableMapOf<Prize, Int>()
        for (ticket in tickets) {
            val matchCount = countMatchingNumbers(ticket)
