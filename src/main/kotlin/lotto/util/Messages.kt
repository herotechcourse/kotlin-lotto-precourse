...
object Messages {
    const val PROMPT_PURCHASE_AMOUNT = "Please enter the purchase amount (must be multiple of ${Config.TICKET_PRICE};  for example: 2000):"
    ...
    const val ERROR_NOT_MULTIPLE_OF_TICKET_PRICE = "[ERROR] Purchase amount must be a multiple of ${Config.TICKET_PRICE} KRW. Received: %d"
