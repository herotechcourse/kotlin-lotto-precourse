...
object PurchaseAmountValidator {
    ...
    private const val AMOUNT_BELOW_MINIMUM = "$ERROR_PREFIX Input must be at least 1000. $PROMPT_AGAIN"
    private const val NOT_DIVISIBLE_BY_UNIT = "$ERROR_PREFIX Input must be in units of 1,000. $PROMPT_AGAIN"
