...
object Messages {
    ...
    const val NOT_A_VALID_NUMBER = ERROR + "Please re-enter a valid number."
    const val WINNING_NUMBER_DUPLICATE = ERROR + "Please re-enter non duplicate numbers."
    const val BONUS_NUMBER_DUPLICATE = ERROR + "Please re-enter non duplicate number with winning numbers."
    const val WINNING_NUMBER_OVER_RANGE = ERROR + "Please re-enter number range in 1 to 45."
    const val WINNING_NUMBER_SIZE_NOT_SIX = ERROR + "Please re-enter 6 numbers."
